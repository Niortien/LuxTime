...
export default function Collection({}: Props) {
 ...
 <div className='flex justify-center gap-8 mt-10'>
  ...
  <button className='border-2 border-[#9F8361] rounded-xl px-8 h-9 '>Woman Luxury</button>
  <button className='border-2 border-[#9F8361] rounded-xl px-8 h-9'>Unisex Luxury</button>
 </div>

 <div className='  flex h-76 mt-10 gap-1 '>
 <div className=" w-[30%] ">
  <Image src={img6} alt='image6'className='w-full h-full object-cover' />
 </div>
 <div className=" grid grid-cols-3 grid-rows-2 w-[70%] gap-1">
 <div className="  col-span-2 ">
 <Image src={img7} alt='image7' className='w-full h-full object-cover'/>
 </div>
 <div className=" ">
 <Image src={img8} alt='image8'className='w-full h-full ' />
 </div>
 <div className=" ">
 <Image src={img9} alt='image9' className='w-full h-full object-cover'/>
 </div>
 <div className=" col-span-2 ">
